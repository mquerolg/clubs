...
# -----------------------------
QUERY = " "
MAX_TOTAL_RESULTS = 100  # nombre total de llibres que vols obtenir
...
for start_index in range(0, MAX_TOTAL_RESULTS, PAGE_SIZE):
    ...
    for item in items:
        ...
        if not (published_date.startswith("2025") or published_date.startswith("2026")):
            continue  # saltar llibres que no siguin del 2025 o 2026

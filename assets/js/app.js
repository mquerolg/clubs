...
const App = (() => {
    ...
    const createFilters = () => {
        ...
        const filterModal = document.querySelector('#filters-box');
        ...
        const filterModalBody = filterModal;
        filterModalBody.innerHTML = '<div class="fa-2x px-0 py-0 text-muted text-center"><i class="fas fa-circle-notch fa-spin"></i></div>';

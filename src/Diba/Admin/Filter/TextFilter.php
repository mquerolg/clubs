...
final class TextFilter implements FilterInterface
{
    ...
    public function apply(QueryBuilder $queryBuilder, FilterDataDto $filterDataDto, ?FieldDto $fieldDto, EntityDto $entityDto): void
    {
        ...
        $queryBuilder
            ->andWhere(sprintf('REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(LOWER(%s.%s),\'á\',\'a\'),\'à\',\'a\'),\'ä\',\'a\'),\'é\',\'e\'),\'è\',\'e\'),\'ë\',\'e\'),\'í\',\'i\'),\'ì\',\'i\'),\'ï\',\'i\'),\'ó\',\'o\'),\'ò\',\'o\'),\'ö\',\'o\'),\'ú\',\'u\'),\'ù\',\'u\'),\'ü\',\'u\') %s :%s', $alias, $property, $comparison, $parameterName))
